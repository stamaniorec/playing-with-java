...
public class Player {
	...
	public void update(Camera cam) {
		...
		// has some bugs with going out of bounds ("staggered" movement) but whaever
		if(y + dy - height/2 < 0) return;
		if(y + dy > map.getHeight() * map.getTileSize()) return;
		if(x + dx - width/2 < 0) return;
